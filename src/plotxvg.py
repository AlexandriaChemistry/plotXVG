...
class DataSet:
    ...
    def do_bars(self, thisax, args, argcolors, idx, total_datasets, setcount, group_width):
        print_legend = False
    ...
    def do_lines(self, thisax, args, argcolors, arglines, argmarkers, setcount):
        print_legend = False
        if args.datasetlegends:
            print_legend = True
        else:
...
def plotxvgRun(args):
    ...
    global viewDebug, nfiles, ncolumn, nrow, fig, axs
