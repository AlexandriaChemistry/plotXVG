...
""",
    ...
    col_x = 1
    parser.add_argument("-csvx", "--csvx", help="Choose what x column you would like from a csv file. Choose only one column. Default is column "+str(col_x), type=int, default=col_x)
    col_y = 3
    parser.add_argument("-csvy", "--csvy", help="Choose what y column(s) you would like from a csv file. Default is column "+str(col_y), nargs="+", type=str, default=str(col_y))
    ...
    parser.add_argument("-cmap", "--cmap", help="Matplotlib colormap", type=str, default="viridis")
...
class APIArguments:
    ...
    def __init__(self, **kwargs):
        ...
        self.axislabelfontsize = kwargs.get("axislabelfontsize", 26)
        self.titlefontsize = kwargs.get("titlefontsize", 30)
        self.legendfontsize = kwargs.get("legendfontsize", 26)
        self.tickfontsize = kwargs.get("tickfontsize", 24)
        self.linestyle = kwargs.get("linestyle", None)
        self.marker = kwargs.get("marker", None)
        self.markersize = kwargs.get("markersize", 10)
        self.markeredgewidth = kwargs.get("markeredgewidth", 2)
        self.colors = kwargs.get("colors", None)
        self.save = kwargs.get("save", None)
        self.squarefig = kwargs.get("squarefig", False)
        self.equalaxes = kwargs.get("equalaxes", False)
        self.bar = kwargs.get("bar", False)
        self.noshow = kwargs.get("noshow", False)
        self.residual = kwargs.get("residual", False)
        self.filelabel = kwargs.get("filelabel", False)
        ...
        self.subfigureX = kwargs.get("subfigureX", -0.15)
        self.subfigureY = kwargs.get("subfigureY", 1.0)
        self.ignore = kwargs.get("ignore", [])
        self.title = kwargs.get("title", None)
        self.notitles = kwargs.get("notitles", False)
        self.datasetlegends = kwargs.get("datasetlegends", None)
        ...
        self.csvx = kwargs.get("csvx", 1)
        self.csvy = kwargs.get("csvy", ["3"])
...
class DataSet:
    ...
    def do_heatmap(self, thisax, args, setcount):
        ...
        if has_z:
            ...
            return print("This file does not contain density data.")
        ...
        cbar.set_label(mylegend, fontsize=args.axislabelfontsize)
        cbar.ax.tick_params(labelsize=args.tickfontsize)

    ####### Helper method for heatmaps ######### 
