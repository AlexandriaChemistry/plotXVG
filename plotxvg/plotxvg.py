...
""",
    ...
    parser.add_argument("-panels", "--panels", help="Generate different panels to plot in, one file per panel. Add 'horizontal' for side-by side panels.", nargs="?", const="vertical", default=None, choices=["vertical", "horizontal"])
    subfigx = -0.15
    subfigy = 1.0
    ...
    for filenumber in range(nfiles):
        ...
        if args.sharelabel and args.panels:
            if args.panels == 'vertical':
                ...
                rowindex = filenumber // nrow #reverse engineering for horizontal panels
...
def main():
    ...
    if args.panels:
        ...
        elif (nrow == 2 or nrow == 3) and args.panels == 'vertical':
            xframe = args.xframe
