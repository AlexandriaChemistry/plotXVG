...
\begin{figure}[H]
    ...
    \caption{Moving the legendbox to the right. Moving the box up and down can be done similarly with -legend\_y.}
    \label{fig:05}
\end{figure}
...
plotxvg -f gmx_files/2dproj_PC1_PC2.xvg -font Tahoma -save \
		plotxvg_tests-output/15font.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/15font.pdf}
...
plotxvg -f gmx_files/eigenval.xvg gmx_files/gyrate.xvg \
		...
		plotxvg_tests-output/16Alot_of_panels.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/16Alot_of_panels.pdf}
    \caption{This demonstrates the dynamics of the program showing that even twelve files can be plotted simultaneously.}
    \label{fig:16}
\end{figure}
...
plotxvg -f other_files/openmm.csv -csvx 2 -csvy 7 -ls solid \
		-save plotxvg_tests-output/17openMMfile.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/17openMMfile.pdf}
...
plotxvg -f gmx_files/rmsd_calpha.xvg \
		...
		plotxvg_tests-output/18fig1_article.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/18fig1_article.pdf}
...
plotxvg -f other_files/gaussian_hill_2d.xvg -heatmap -save \
		plotxvg_tests-output/18heatmap.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/18heatmap.pdf}
    \caption{Heatmap using matplotlib's pcolormesh}
    \label{fig:19}
\end{figure}
...
plotxvg -f other_files/gaussian_hill_2d.xvg -contour -save \
		plotxvg_tests-output/19contour.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/19contour.pdf}
    \caption{contour using matplotlib's contourf and contour}
    \label{fig:20}
\end{figure}
...
plotxvg -f act_files/COULOMB-PC-elec.xvg \
		...
		-save plotxvg_tests-output/19fig2_article.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/19fig2_article.pdf}
...
plotxvg -f gmx_files/rmsd_calpha.xvg \
		...
		dotted dashdot dashed None -mk None None None o + x ^ + \
		-panels -tfs 45 -alfs 40 -mksize 20 -mkwidth 4 -save \
		plotxvg_tests-output/20fig1_article.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/20fig1_article.pdf}
    \caption{The exact run for reproducing Fig.1 in the article.}
    \label{fig:22}
\end{figure}
...
plotxvg -f other_files/openmm.csv -csvx 2 -csvy 7 -alfs 38 \
		-ls solid -save plotxvg_tests-output/20fig3_article.pdf \
		-noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/20fig3_article.pdf}
...
plotxvg -f act_files/COULOMB-PC-elec.xvg \
		act_files/COULOMB-PC+GS-elec.xvg -dslegends 'PC-elec' \
		'PC+GS-elec' -lfs 18 -eqax -sharelabel -stats -panels side \
		-save plotxvg_tests-output/21fig2_article.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/21fig2_article.pdf}
    \caption{The exact run for reproducing Fig.2 in the article.}
    \label{fig:24}
\end{figure}
...
\begin{verbatim}
plotxvg -f other_files/openmm.csv -csvx 2 -csvy 7 -alfs 38 \
		-ls solid -save plotxvg_tests-output/22fig3_article.pdf \
		-noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/22fig3_article.pdf}
    \caption{The exact run for reproducing Fig.3 in the article.}
    \label{fig:25}
\end{figure}
