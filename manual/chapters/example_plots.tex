...
plotxvg -f other_files/test_normaldist.xvg -heatmap -save \
		plotxvg_tests-output/19heatmap_wo_z.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/19heatmap_wo_z.pdf}
...
\begin{verbatim}
plotxvg -f other_files/test_normaldist.xvg -contour -save \
		plotxvg_tests-output/20contour.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../tests/plotxvg_tests-output/20contour.pdf}
