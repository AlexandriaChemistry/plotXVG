...
\begin{verbatim}
plotxvg -f other_files/test_normaldist.xvg -heatmap -allfs \
		12 -save plotxvg_tests-output/19heatmap.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
...
plotxvg -f gmx_files/2dproj_PC1_PC2.xvg -contour -kde \
		-showdots -allfs 12 -save \
		plotxvg_tests-output/20contour_kde.pdf -noshow
\end{verbatim}
\begin{figure}[H]
    \centering
...
plotxvg -f gmx_files/rmsd_calpha.xvg \
		gmx_files/temp_press.xvg gmx_files/gyrate.xvg \
		gmx_files/rmsf_residues.xvg -ls solid solid solid solid \
...
\begin{verbatim}
plotxvg -f other_files/openmm.csv -csvx 2 -csvy 7 -axfs 38 \
