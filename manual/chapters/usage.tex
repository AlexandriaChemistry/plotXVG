...
\end{verbatim}
The input file should contain three columns: x-coordinates, y-coordinates, and values to be mapped to the color scale. 
...
See example plots in Figures \ref{fig:19} and \ref{fig:20}.