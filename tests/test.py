...
all_examples = [
    ...
    ("nofilelegends", "Demonstrates the -nofilelegends flag. File-defined legends are ignored; only user-defined legends from -dslegends are shown.", "act_files/COULOMB-PC-elec.xvg act_files/COULOMB-PC+GS-elec.xvg", "-dslegends 'PC-elec' 'PC+GS-elec' -nofilelegends -eqax -sharelabel -panels side"),
    ...
    ("grid_panels_1x2", "Demonstrates the AxB grid panels format where A rows and B columns are specified and files are distributed evenly across the subplots. Here 4 files are distributed over a 1x2 grid (2 files per panel).", "gmx_files/rmsd_calpha.xvg gmx_files/rmsd_sidechain.xvg gmx_files/gyrate.xvg gmx_files/potential_energy.xvg", "-panels 1x2 -sharelabel -ls solid"),
    ("grid_panels_2x3", "Five data files distributed over a 2x3 grid (2 rows, 3 columns), with ceil(5/6)=1 file per panel (last panel empty).", "gmx_files/rmsd_calpha.xvg gmx_files/rmsd_sidechain.xvg gmx_files/gyrate.xvg gmx_files/potential_energy.xvg gmx_files/resarea.xvg", "-panels 2x3 -ls solid"),
    ("grid_panels_3x2", "Six data files distributed over a 3x2 grid (3 rows, 2 columns), resulting in 1 file per panel.", "gmx_files/rmsd_calpha.xvg gmx_files/rmsd_sidechain.xvg gmx_files/gyrate.xvg gmx_files/potential_energy.xvg gmx_files/resarea.xvg gmx_files/sasa_total.xvg", "-panels 3x2 -ls solid"),
