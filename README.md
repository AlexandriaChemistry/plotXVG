### plotXVG
This repository represents plotXVG, an efficient and easy-to-use python tool to generate publication-quality graphics from GROMACS-generated xvg-files without any programming. 
...
To use plotXVG, simply type "plotxvg -f filename.xvg" in your commandline and it will generate a plot. Default setting is a scatterplot, if you want to plot in lines, add the -ls flag along with a line argument such as 'solid'.
